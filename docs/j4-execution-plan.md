...
| # | Task | Repo(s) | Model | Review |
|---|---|---|---|---|
| B0a | "One authority per fact" decision + supersede-header convention; apply supersede headers to known-stale sections. **DONE 2026-08-25** — [decisions/0001](decisions/0001-one-authority-per-fact.md), [decisions/0002](decisions/0002-supersede-convention.md), [fact-ownership.md](fact-ownership.md), `scripts/check-doc-facts.py`. | docs | **Opus** (decision) → **Sonnet** (apply) | Opus design-review |
