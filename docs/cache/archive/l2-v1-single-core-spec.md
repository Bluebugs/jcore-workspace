...
> **Superseded.** L2 v1 was the single-core, non-coherent design. Replaced by ../l2-spec.md (v2 coherent) on 2026-05-26.
...
For FGMT with two threads and stride prefetching active, 4 MSHRs is comfortable. Lower counts (2) work but cause more stalls under heavy miss bursts. Higher counts (8) help marginally.
